...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(com.placement.platform.premium.exception.PremiumAccessDeniedException.class)
    public ResponseEntity<ErrorResponse> handlePremiumAccessDenied(com.placement.platform.premium.exception.PremiumAccessDeniedException ex) {
        ErrorResponse error = new ErrorResponse(
                HttpStatus.FORBIDDEN.value(),
                ex.getMessage()
        );
